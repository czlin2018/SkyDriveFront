  ...
  <div class="login-wrap">
    <div class="ms-login">
      ...
      <el-form  :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="ms-content"> 
        ...
        <p class="login-tips">Tips : 缺少账号的用请
          <el-button type="text" size="medium" @click="openReg">注册</el-button>
        </p>
      </el-form>
      </div>
       <div v-if="showReg">
      <el-form v-if="showReg" :model="regForm" :rules="regRules" ref="regForm" label-width="0px" class="ms-content"> 
        ...
        <el-form-item prop="code">
          ...
          >
           ...
           <el-button type="primary" size="mini" @click="acceptCode" :disabled="disabled">{{codeStauts}}</el-button>
        </el-form-item>
           <el-form-item>
...
export default {
  ...
  methods: {
    ...
    acceptCode(){
       this.$axios
            .get("http://localhost:9100/register/getVerificationCode?userId=" + this.regForm.email)
            .then(res => {
              if (res.data.code === 0) {
                this.disabled = true
