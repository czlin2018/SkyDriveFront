      ...
      <el-col :span="8">
        ...
        <el-card shadow="hover" style="height:252px;">
          ...
          <div style="text-align: center">
            <el-progress type="circle" :percentage="seted" color="#8e71c7"></el-progress>
            <el-progress type="circle" :percentage="usered" color="#8e71c7"></el-progress>
          </div>
          <dev
            style="text-align: center"
          >网盘容量:{{size}}MB,已分配{{sizeSetUsred}}Mb,已使用{{sizeHadUsred}}Mb</dev>
        </el-card>
      </el-col>
      <el-col :span="16">
...
export default {
  ...
  methods: {
    ...
    getSize() {
      console.log("获得大小");
      this.$axios.get("http://localhost:9200/getSizeForAdmin").then(res => {
        console.log("res", res);
        if (res.data.code === 0) {
          this.size = res.data.data.size;
          this.sizeSetUsred = res.data.data.sizeSetUsred;
          this.sizeHadUsred = res.data.data.sizeHadUsred;
          this.seted = res.data.data.seted;
          this.usered = res.data.data.usered;
        }
      });
    },
    getUserNum() {
